  ...
  .datepicker__wrapper(v-if='show' @blur="clickOutside" :class="`${openMode ? 'datepicker__wrapper--open-mode' : ''}`" :style="design === 'inline' && !openMode || hideInput ? {background: 'none'} : ''")
    .datepicker__close-button.-hide-on-desktop(v-if='isOpen && !openMode' @click='hideDatepicker')
      svg(width="30px" height="30px" viewBox="0 0 30 30")
        path(d="M13.5450577,15.5 L7.9048818,9.85982408 C7.3650394,9.31998168 7.3650394,8.44472421 7.9048818,7.9048818 C8.44472421,7.3650394 9.31998168,7.3650394 9.85982408,7.9048818 L15.5,13.5450577 L21.1401759,7.9048818 C21.6800183,7.3650394 22.5552758,7.3650394 23.0951182,7.9048818 C23.6349606,8.44472421 23.6349606,9.31998168 23.0951182,9.85982408 L17.4549423,15.5 L23.0951182,21.1401759 C23.6349606,21.6800183 23.6349606,22.5552758 23.0951182,23.0951182 C22.5552758,23.6349606 21.6800183,23.6349606 21.1401759,23.0951182 L15.5,17.4549423 L9.85982408,23.0951182 C9.31998168,23.6349606 8.44472421,23.6349606 7.9048818,23.0951182 C7.3650394,22.5552758 7.3650394,21.6800183 7.9048818,21.1401759 L13.5450577,15.5 Z" id="Path" fill-rule="nonzero")
    ...
    .datepicker( :class="`${ isOpen ? 'datepicker--open' : 'datepicker--closed' } ${openMode ? 'datepicker--open-mode' : ''} ${alignRight ? 'datepicker--align-right' : ''} ${hideInput ? 'datepicker--hide-input' : ''}`" :style="{background: backgroundColor}")
      ...
      .datepicker__inner
        ...
        span.datepicker__custom-clear-button(v-if='!openMode' @click='clearSelection' :style="clearStyle") Reset
        ...
        if (this.checkIn && this.checkOut) {
          ...
          for (let monthIndex in this.months) {
            ...
            if (checkOutMY === monthMY) {
              startUnusedIndex = parseInt(monthIndex) + 1;
              break;
            }
          }
